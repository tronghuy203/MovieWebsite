...
const ManageMovie = () => {
  ...
  const deleteMovieIsFetching = useSelector(
    (state) => state.movie.deleteMovie?.isFetching
  );
  ...
  return (
    <div className="bg-slate-400">
      <LoadingOverlay isFetching={deleteMovieIsFetching} />
      ...
      <div className="hidden lg:block w-[90%] min-h-[calc(100vh)] mx-auto bg-slate-300 shadow-black shadow-2xl rounded-lg overflow-hidden">
        <table className="w-full h-full">
          <thead className="bg-gray-800 text-white">
            <tr className="">
              <th className="px-6 py-4 text-center">Ảnh</th>
              <th className="px-6 py-4 text-center">Tên phim</th>
              <th className="px-6 py-4 text-center">Thể loại</th>

...
import { clearMessageErrorRegister } from "../../redux/authSlice";
...
const Register = () => {
  ...
  const registerIsFetching = useSelector(
  ...
  useEffect(() => {
    dispatch(clearMessageErrorRegister());
  }, [dispatch]);
  return (
    <div className="relative h-[750px]">
       <LoadingOverlay isFetching={registerIsFetching}/>
      <div className="absolute bg-slate-600 z-0 w-full h-[750px]"></div>
      <div className="absolute left-1/2 transform -translate-x-1/2 z-10 w-[320px] h-[600px] lg:w-[500px] lg:h-[600px] bg-slate-800 rounded-lg my-5 mt-20 ">
